...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="p-4 rounded-2xl bg-indigo-50/80 dark:bg-indigo-900/30 border border-indigo-100 dark:border-indigo-800/60 flex items-start gap-3 text-indigo-900 dark:text-indigo-200">
        ...
        <div class="text-xs leading-relaxed">
            <strong class="font-bold block text-sm mb-0.5">Memperbarui Referensi AI:</strong>
            Setiap perubahan pada pertanyaan atau jawaban ini akan langsung mempengaruhi cara AI Chatbot menganalisis dan menjawab keluhan pelapor berikutnya secara *real-time*.
        </div>
    </div>
