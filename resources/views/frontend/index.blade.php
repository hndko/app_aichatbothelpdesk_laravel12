...
<section class="relative bg-gradient-to-r from-blue-700 via-indigo-800 to-slate-900 py-20 px-4 text-center overflow-hidden">
    ...
    <div class="max-w-4xl mx-auto relative z-10">
        <span class="inline-flex items-center gap-1.5 bg-white/10 dark:bg-white/5 text-blue-200 dark:text-blue-300 backdrop-blur-md px-4 py-1.5 rounded-full text-xs font-semibold mb-6 border border-white/20 shadow-sm animate-fade-in">
            <svg class="w-4 h-4 flex-shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20"><path d="M10 0a10 10 0 1 0 10 10A10.011 10.011 0 0 0 10 0Zm0 5a3 3 0 1 1 0 6 3 3 0 0 1 0-6Zm0 13a8.949 8.949 0 0 1-4.951-1.488A3.987 3.987 0 0 1 9 13h2a3.987 3.987 0 0 1 3.951 3.512A8.949 8.949 0 0 1 10 18Z"/></svg>
...
<div class="max-w-3xl mx-auto px-4 -mt-8 relative z-20">
    <div class="bg-white dark:bg-gray-800 p-2 sm:p-3 rounded-2xl shadow-2xl border border-gray-100 dark:border-gray-700">
        <form action="{{ route('portal') }}" method="GET" class="flex flex-col sm:flex-row gap-2">
            ...
            <button type="submit"
                class="text-white bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-semibold rounded-xl text-sm px-6 py-3 text-center transition-all shadow-md flex-shrink-0">
                Cari Solusi
            </button>
        </form>
    </div>
...
<section class="max-w-7xl mx-auto px-4 py-12">
        ...
        @foreach($categories as $cat)
            <a href="{{ route('portal', ['category_id' => $cat->id, 'search' => request('search')]) }}"
                ...
                @if($cat->name === 'hardware')
                    <svg class="w-4 h-4 flex-shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20"><path d="M18 10h-1V6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v4H2a1 1 0 0 0 0 2h1v4a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2v-4h1a1 1 0 0 0 0-2ZM6 6h8v8H6V6Z"/></svg>
                @elseif($cat->name === 'software')
                    <svg class="w-4 h-4 flex-shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20"><path d="M18 2H2a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2ZM2 6h16v12H2V6Z"/></svg>
                @elseif($cat->name === 'network')
                    <svg class="w-4 h-4 flex-shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 12v.01M16.5 7.5a6 6 0 0 0-9 0m12 3a9 9 0 0 0-15 0"/></svg>
                @else
                    <svg class="w-4 h-4 flex-shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20"><path d="m18.774 8.245-.892-.893a1.5 1.5 0 0 1-.437-1.052V5.036a2.484 2.484 0 0 0-2.48-2.48H13.7a1.5 1.5 0 0 1-1.052-.438l-.893-.892a2.484 2.484 0 0 0-3.51 0l-.893.892a1.5 1.5 0 0 1-1.052.437H5.036a2.484 2.484 0 0 0-2.48 2.481V6.3a1.5 1.5 0 0 1-.438 1.052l-.892.893a2.484 2.484 0 0 0 0 3.51l.892.893a1.5 1.5 0 0 1 .437 1.052v1.264a2.484 2.484 0 0 0 2.481 2.481H6.3a1.5 1.5 0 0 1 1.052.437l.893.892a2.484 2.484 0 0 0 3.51 0l.893-.892a1.5 1.5 0 0 1 1.052-.437h1.264a2.484 2.484 0 0 0 2.481-2.48V13.7a1.5 1.5 0 0 1 .437-1.052l.892-.893a2.484 2.484 0 0 0 0-3.51Z"/><path fill="#fff" d="M8 13a1 1 0 0 1-.707-.293l-2-2a1 1 1 1.414-1.414l1.42 1.42 5.318-3.545a1 1 0 0 1 1.11 1.664l-6 4A1 1 0 0 1 8 13Z"/></svg>
                @endif
    ...
    <div class="flex flex-col sm:flex-row items-center justify-between bg-blue-50/60 dark:bg-gray-800/80 p-4 rounded-2xl mb-8 border border-blue-100 dark:border-gray-700 text-sm">
        ...
        <a href="{{ route('portal') }}"
            ...
            <svg class="w-4 h-4 flex-shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20"><path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 11.793a1 1 0 1 1-1.414 1.414L10 11.414l-2.293 2.293a1 1 0 0 1-1.414-1.414L8.586 10 6.293 7.707a1 1 0 0 1 1.414-1.414L10 8.586l2.293-2.293a1 1 0 0 1 1.414 1.414L11.414 10l2.293 2.293Z"/></svg>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-700 flex flex-col justify-between hover:shadow-lg transition-all transform hover:-translate-y-1">
            <div>
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span class="text-xs text-gray-400 flex items-center gap-1">
                        <svg class="w-3.5 h-3.5 flex-shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20"><path d="M10 0a10 10 0 1 0 10 10A10.011 10.011 0 0 0 10 0Zm3.982 13.982a1 1 0 0 1-1.414 0l-3.274-3.274A1.012 1.012 0 0 1 9 10V6a1 1 0 0 1 2 0v3.586l2.982 2.982a1 1 0 0 1 0 1.414Z"/></svg>
            ...
            <button type="button" data-modal-target="faqModal{{ $article->id }}"
                ...
                <svg class="w-4 h-4 flex-shrink-0 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 12H5m14 0-4 4m4-4-4-4"/></svg>
            </button>
        </div>
                ...
                <div class="relative bg-white rounded-2xl shadow-2xl dark:bg-gray-800 border border-gray-100 dark:border-gray-700 overflow-hidden">
                    ...
                    <div class="p-6 space-y-4">
                        <h4 class="text-base font-bold text-blue-600 dark:text-blue-400 flex items-center gap-2">
                            <svg class="w-5 h-5 flex-shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20"><path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z"/></svg>
    ...
    <div class="bg-gradient-to-r from-slate-900 via-indigo-950 to-blue-900 text-white p-8 sm:p-12 rounded-3xl text-center shadow-xl relative overflow-hidden border border-white/10">
        <div class="relative z-10 max-w-xl mx-auto">
            ...
            <a href="{{ route('tiket.create') }}"
                ...
                <svg class="w-5 h-5 flex-shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20"><path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm1 13a1 1 0 1 1-2 0v-3H6a1 1 0 1 1 0-2h3V6a1 1 0 1 1 2 0v3h3a1 1 0 1 1 0 2h-3v3Z"/></svg>
                <span>Buat Tiket Kendala Baru</span>
            </a>
            @else
            <a href="{{ route('login') }}"
                class="inline-flex items-center gap-2 text-white bg-blue-600 hover:bg-blue-700 font-semibold rounded-xl text-base px-6 py-3.5 shadow-lg shadow-blue-600/30 transition-all transform hover:-translate-y-0.5">
                <svg class="w-5 h-5 flex-shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 12H4m12 0-4 4m4-4-4-4m3-4v12a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2Z"/></svg>
